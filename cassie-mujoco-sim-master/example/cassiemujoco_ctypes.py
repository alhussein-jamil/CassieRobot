...
cassie_core_sim_copy.argtypes = [
    POINTER_T(struct_CassieCoreSim),
    POINTER_T(struct_CassieCoreSim),
]
...
cassie_core_sim_step.argtypes = [
    POINTER_T(struct_CassieCoreSim),
    POINTER_T(struct_c__SA_cassie_user_in_t),
    POINTER_T(struct_c__SA_cassie_out_t),
    POINTER_T(struct_c__SA_cassie_in_t),
]
...
cassie_sim_step_pd.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(struct_c__SA_state_out_t),
    POINTER_T(struct_c__SA_pd_in_t),
]

cassie_sim_step_pd_no2khz = _libraries["./libcassiemujoco.so"].cassie_sim_step_pd_no2khz
cassie_sim_step_pd_no2khz.restype = None
cassie_sim_step_pd_no2khz.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(struct_c__SA_state_out_t),
    POINTER_T(struct_c__SA_pd_in_t),
]
...
cassie_sim_check_obstacle_collision = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_check_obstacle_collision
...
cassie_sim_check_self_collision = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_check_self_collision
...
cassie_sim_heeltoe_forces.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_double * 6,
    ctypes.c_double * 6,
]
...
cassie_sim_foot_velocities = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_foot_velocities
cassie_sim_foot_velocities.restype = None
cassie_sim_foot_velocities.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_double * 12,
]
...
cassie_sim_centroid_inertia = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_centroid_inertia
cassie_sim_centroid_inertia.restype = None
cassie_sim_centroid_inertia.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_double * 9,
]

cassie_sim_angular_momentum = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_angular_momentum
cassie_sim_angular_momentum.restype = None
cassie_sim_angular_momentum.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_double * 3,
]

cassie_sim_full_mass_matrix = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_full_mass_matrix
cassie_sim_full_mass_matrix.restype = None
cassie_sim_full_mass_matrix.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_double * (32 * 32),
]

cassie_sim_minimal_mass_matrix = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_minimal_mass_matrix
cassie_sim_minimal_mass_matrix.restype = None
cassie_sim_minimal_mass_matrix.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_double * (16 * 16),
]

cassie_sim_loop_constraint_info = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_loop_constraint_info
cassie_sim_loop_constraint_info.restype = None
cassie_sim_loop_constraint_info.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_double * (6 * 32),
    ctypes.c_double * (6),
]
...
cassie_sim_apply_force.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_double * 6,
    ctypes.c_char_p,
]
...
cassie_sim_get_hfield_nrow = _libraries[
    "./libcassiemujoco.so"
...
cassie_sim_get_hfield_ncol = _libraries[
    "./libcassiemujoco.so"
...
cassie_sim_get_nhfielddata = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_get_nhfielddata
cassie_sim_get_nhfielddata.restype = ctypes.c_int32
cassie_sim_get_nhfielddata.argtypes = [POINTER_T(struct_cassie_sim)]

cassie_sim_get_hfield_size = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_get_hfield_size
...
cassie_sim_set_hfield_size = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_hfield_size
cassie_sim_set_hfield_size.restype = None
cassie_sim_set_hfield_size.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_double * 4,
]
...
cassie_vis_set_cam.argtypes = [
    POINTER_T(struct_cassie_vis),
    ctypes.c_char_p,
    ctypes.c_double,
    ctypes.c_double,
    ctypes.c_double,
...
cassie_vis_set_cam_pos.argtypes = [
    POINTER_T(struct_cassie_vis),
    POINTER_T(ctypes.c_double),
    ctypes.c_double,
    ctypes.c_double,
    ctypes.c_double,
]
...
cassie_vis_window_resize.argtypes = [
    POINTER_T(struct_cassie_vis),
    ctypes.c_int32,
    ctypes.c_int32,
]
...
cassie_vis_draw_depth.argtypes = [
    POINTER_T(struct_cassie_vis),
    POINTER_T(struct_cassie_sim),
    ctypes.c_int32,
    ctypes.c_int32,
...
cassie_vis_get_depth_size.argtypes = [
    POINTER_T(struct_cassie_vis),
    ctypes.c_int32,
    ctypes.c_int32,
]
...
cassie_vis_init_depth.argtypes = [
    POINTER_T(struct_cassie_vis),
    ctypes.c_int,
    ctypes.c_int,
]
...
cassie_vis_apply_force.argtypes = [
    POINTER_T(struct_cassie_vis),
    POINTER_T(ctypes.c_double),
    ctypes.c_char_p,
]
...
cassie_vis_add_marker.argtypes = [
    POINTER_T(struct_cassie_vis),
    ctypes.c_double * 3,
    ctypes.c_double * 3,
    ctypes.c_double * 4,
...
cassie_vis_update_marker_pos = _libraries[
    "./libcassiemujoco.so"
].cassie_vis_update_marker_pos
cassie_vis_update_marker_pos.restype = None
cassie_vis_update_marker_pos.argtypes = [
    POINTER_T(struct_cassie_vis),
    ctypes.c_int,
    ctypes.c_double * 3,
]

cassie_vis_update_marker_size = _libraries[
    "./libcassiemujoco.so"
].cassie_vis_update_marker_size
cassie_vis_update_marker_size.restype = None
cassie_vis_update_marker_size.argtypes = [
    POINTER_T(struct_cassie_vis),
    ctypes.c_int,
    ctypes.c_double * 3,
]

cassie_vis_update_marker_rgba = _libraries[
    "./libcassiemujoco.so"
].cassie_vis_update_marker_rgba
cassie_vis_update_marker_rgba.restype = None
cassie_vis_update_marker_rgba.argtypes = [
    POINTER_T(struct_cassie_vis),
    ctypes.c_int,
    ctypes.c_double * 4,
]

cassie_vis_update_marker_orient = _libraries[
    "./libcassiemujoco.so"
].cassie_vis_update_marker_orient
cassie_vis_update_marker_orient.restype = None
cassie_vis_update_marker_orient.argtypes = [
    POINTER_T(struct_cassie_vis),
    ctypes.c_int,
    ctypes.c_double * 9,
]
...
cassie_vis_init_recording.argtypes = [
    POINTER_T(struct_cassie_vis),
    ctypes.c_char_p,
    ctypes.c_int32,
    ctypes.c_int32,
...
cassie_vis_close_recording = _libraries[
    "./libcassiemujoco.so"
].cassie_vis_close_recording
...
cassie_state_copy.argtypes = [
    POINTER_T(struct_cassie_state),
    POINTER_T(struct_cassie_state),
]
...
cassie_set_state.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(struct_cassie_state),
]

cassie_sim_read_rangefinder = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_read_rangefinder
cassie_sim_read_rangefinder.restype = None
cassie_sim_read_rangefinder.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_double * 6,
]
...
cassie_sim_set_dof_damping = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_dof_damping
cassie_sim_set_dof_damping.restype = None
cassie_sim_set_dof_damping.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
]
...
cassie_sim_set_body_mass.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
]

cassie_sim_set_body_name_mass = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_body_name_mass
cassie_sim_set_body_name_mass.restype = None
cassie_sim_set_body_name_mass.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_char_p,
    ctypes.c_double,
]
...
cassie_sim_get_body_name_pos = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_get_body_name_pos
...
cassie_sim_set_body_name_pos = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_body_name_pos
cassie_sim_set_body_name_pos.restype = None
cassie_sim_set_body_name_pos.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_char_p,
    POINTER_T(ctypes.c_double),
]
...
cassie_sim_set_body_ipos.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
]
...
cassie_sim_set_geom_friction = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_geom_friction
cassie_sim_set_geom_friction.restype = None
cassie_sim_set_geom_friction.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
]

cassie_sim_set_geom_name_friction = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_geom_name_friction
cassie_sim_set_geom_name_friction.restype = None
cassie_sim_set_geom_name_friction.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_char_p,
    POINTER_T(ctypes.c_double),
]

cassie_sim_get_geom_name_friction = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_get_geom_name_friction
cassie_sim_get_geom_name_friction.restype = POINTER_T(ctypes.c_double)
cassie_sim_get_geom_name_friction.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_char_p,
]
...
cassie_sim_set_geom_rgba.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_float),
]

cassie_sim_set_geom_name_rgba = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_geom_name_rgba
cassie_sim_set_geom_name_rgba.restype = None
cassie_sim_set_geom_name_rgba.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_char_p,
    POINTER_T(ctypes.c_float),
]
...
cassie_sim_set_geom_quat.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
]

cassie_sim_set_geom_name_quat = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_geom_name_quat
cassie_sim_set_geom_name_quat.restype = None
cassie_sim_set_geom_name_quat.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_char_p,
    POINTER_T(ctypes.c_double),
]
...
cassie_sim_set_geom_pos.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
]

cassie_sim_set_geom_name_pos = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_geom_name_pos
cassie_sim_set_geom_name_pos.restype = None
cassie_sim_set_geom_name_pos.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_char_p,
    POINTER_T(ctypes.c_double),
]
...
cassie_sim_set_geom_size.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
]

cassie_sim_set_geom_name_size = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_geom_name_size
cassie_sim_set_geom_name_size.restype = None
cassie_sim_set_geom_name_size.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_char_p,
    POINTER_T(ctypes.c_double),
]
...
cassie_sim_relative_pose.argtypes = [
    POINTER_T(ctypes.c_double),
    POINTER_T(ctypes.c_double),
    POINTER_T(ctypes.c_double),
    POINTER_T(ctypes.c_double),
...
cassie_sim_get_joint_filter = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_get_joint_filter
cassie_sim_get_joint_filter.restype = None
cassie_sim_get_joint_filter.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
]

cassie_sim_set_joint_filter = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_joint_filter
cassie_sim_set_joint_filter.restype = None
cassie_sim_set_joint_filter.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
    POINTER_T(ctypes.c_double),
]
...
cassie_sim_get_drive_filter.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
]

cassie_sim_set_drive_filter = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_drive_filter
cassie_sim_set_drive_filter.restype = None
cassie_sim_set_drive_filter.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
]
...
cassie_sim_torque_delay.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
]

cassie_sim_set_torque_delay = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_set_torque_delay
cassie_sim_set_torque_delay.restype = None
cassie_sim_set_torque_delay.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
]
...
cassie_sim_get_jacobian.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
    ctypes.c_char_p,
]
...
cassie_sim_mj_name2id.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_char_p,
    ctypes.c_char_p,
]

cassie_sim_get_jacobian_full = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_get_jacobian_full
cassie_sim_get_jacobian_full.restype = None
cassie_sim_get_jacobian_full.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
    POINTER_T(ctypes.c_double),
    ctypes.c_char_p,
...
cassie_sim_get_jacobian_full_site = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_get_jacobian_full_site
cassie_sim_get_jacobian_full_site.restype = None
cassie_sim_get_jacobian_full_site.argtypes = [
    POINTER_T(struct_cassie_sim),
    POINTER_T(ctypes.c_double),
    POINTER_T(ctypes.c_double),
    ctypes.c_char_p,
...
cassie_sim_body_contact_force = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_body_contact_force
cassie_sim_body_contact_force.restype = None
cassie_sim_body_contact_force.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_double * 6,
    ctypes.c_char_p,
]

cassie_sim_body_acceleration = _libraries[
    "./libcassiemujoco.so"
].cassie_sim_body_acceleration
cassie_sim_body_acceleration.restype = None
cassie_sim_body_acceleration.argtypes = [
    POINTER_T(struct_cassie_sim),
    ctypes.c_double * 6,
    ctypes.c_char_p,
]
...
pd_input_step.argtypes = [
    POINTER_T(struct_PdInput),
    POINTER_T(struct_c__SA_pd_in_t),
    POINTER_T(struct_c__SA_cassie_out_t),
    POINTER_T(struct_c__SA_cassie_user_in_t),
]
...
state_output_copy.argtypes = [
    POINTER_T(struct_StateOutput),
    POINTER_T(struct_StateOutput),
]
...
process_packet_header.argtypes = [
    POINTER_T(struct_c__SA_packet_header_info_t),
    POINTER_T(ctypes.c_ubyte),
    POINTER_T(ctypes.c_ubyte),
]
...
__all__ = [
    ...
    "cassie_in_t",
    "state_terrain_out_t",
    "struct_c__SA_pd_leg_in_t",
    "cassie_state_free",
    "struct_c__SA_state_battery_out_t",
    "elmo_in_t",
    "state_joint_out_t",
    "send_packet",
    "cassie_pelvis_out_t",
    "cassie_cleanup",
    "struct_c__SA_state_radio_out_t",
    "cassie_vis_valid",
    "pd_input_setup",
    "pd_leg_in_t",
    "cassie_mujoco_init",
    "cassie_state_copy",
    "cassie_core_sim_setup",
    "battery_out_t",
    "cassie_sim_hold",
    "struct_CassieCoreSim",
    "cassie_core_sim_step",
    "pack_cassie_out_t",
    "cassie_out_t",
    "radio_in_t",
    "unpack_cassie_out_t",
    "struct_c__SA_pd_task_in_t",
    "struct_PdInput",
    "udp_init_client",
    "pd_motor_in_t",
    "cassie_sim_t",
    "cassie_core_sim_alloc",
    "get_newest_packet",
    "size_t",
    "struct_c__SA_vectornav_out_t",
    "struct_c__SA_pd_motor_in_t",
    "cassie_get_state",
    "state_battery_out_t",
    "struct_c__SA_state_pelvis_out_t",
    "cassie_state_qpos",
    "cassie_state_qvel",
    "state_radio_out_t",
    "struct_c__SA_pd_in_t",
    "udp_close",
    "state_output_free",
    "cassie_core_sim_free",
    "pd_task_in_t",
    "packet_header_info_t",
    "pd_in_t",
    "struct_cassie_vis",
    "struct_c__SA_elmo_out_t",
    "pack_pd_in_t",
    "struct_c__SA_radio_out_t",
    "pd_input_alloc",
    "DiagnosticCodes",
    "unpack_state_out_t",
    "target_pc_out_t",
    "cassie_sim_duplicate",
    "cassie_state_alloc",
    "cassie_sim_init",
    "struct_c__SA_cassie_user_in_t",
    "struct_c__SA_radio_in_t",
    "socklen_t",
    "cassie_vis_init",
    "state_out_t",
    ...
    "struct_c__SA_cassie_pelvis_in_t",
    "unpack_pd_in_t",
    "cassie_user_in_t",
    "cassie_sim_clear_forces",
    "cassie_vis_t",
    "struct_c__SA_target_pc_out_t",
    "pd_input_step",
    "cassie_set_state",
    "struct_c__SA_battery_out_t",
    "vectornav_out_t",
    "struct_c__SA_packet_header_info_t",
    "cassie_sim_step_pd",
    "struct_sockaddr",
    "cassie_vis_draw",
    "cassie_integrate_pos",
    "cassie_core_sim_copy",
    "unpack_cassie_in_t",
    "struct_cassie_sim",
    "unpack_cassie_user_in_t",
    "cassie_sim_step",
    "udp_init_host",
    "state_motor_out_t",
    "cassie_core_sim_t",
    ...
    "state_output_t",
    "cassie_sim_time",
    "cassie_sim_step_ethercat",
    "cassie_sim_check_obstacle_collision",
    "elmo_out_t",
    "pack_cassie_in_t",
    "cassie_sim_apply_force",
    "cassie_sim_full_reset",
    "cassie_leg_out_t",
    "wait_for_packet",
    "struct_c__SA_cassie_leg_in_t",
    "struct_c__SA_state_joint_out_t",
    "process_packet_header",
    "cassie_sim_release",
    "cassie_sim_foot_forces",
    "cassie_sim_foot_positions",
    "cassie_sim_foot_velocities",
    "struct_c__SA_state_foot_out_t",
    "cassie_sim_cm_position",
    "cassie_sim_centroid_inertia",
    "cassie_sim_cm_velocity",
    "cassie_sim_angular_momentum",
    "cassie_sim_full_mass_matrix",
    "cassie_sim_minimal_mass_matrix",
    "pd_input_t",
    "pack_cassie_user_in_t",
    "cassie_state_duplicate",
    "state_pelvis_out_t",
    "struct_c__SA_state_terrain_out_t",
    "cassie_sim_free",
    "cassie_sim_xpos",
    "cassie_sim_xquat",
    "ssize_t",
    ...
    "radio_out_t",
    "state_output_step",
    "struct_c__SA_state_motor_out_t",
    "struct_cassie_state",
    "cassie_state_time",
    "cassie_sim_qvel",
    "cassie_sim_qpos",
    "cassie_sim_qacc",
    "struct_c__SA_elmo_in_t",
    "cassie_joint_out_t",
    "cassie_leg_in_t",
    "struct_c__SA_cassie_joint_out_t",
    "struct_c__SA_state_out_t",
    "struct_c__SA_cassie_pelvis_out_t",
    "pd_input_copy",
    "cassie_sim_copy",
    "struct_c__SA_cassie_out_t",
    "cassie_sim_dof_damping",
    "cassie_sim_set_dof_damping",
    "cassie_sim_body_mass",
    "cassie_sim_set_body_mass",
    "cassie_sim_loop_constraint_info",
    "cassie_sim_body_ipos",
    "cassie_sim_set_body_ipos",
    "cassie_sim_geom_friction",
    "cassie_sim_set_geom_friction",
    "cassie_sim_get_geom_name_friction",
    "cassie_sim_set_const",
    "cassie_sim_geom_rgba",
    "cassie_sim_geom_name_rgba",
    "cassie_sim_set_geom_rgba",
    "cassie_sim_set_geom_name_rgba",
    "cassie_sim_geom_quat",
    "cassie_sim_geom_name_quat",
    "cassie_sim_set_geom_quat",
    "cassie_sim_set_geom_name_quat",
    "cassie_sim_geom_pos",
    "cassie_sim_geom_name_pos",
    "cassie_sim_set_geom_pos",
    "cassie_sim_set_geom_name_pos",
    "cassie_sim_geom_size",
    "cassie_sim_geom_name_size",
    "cassie_sim_set_geom_size",
    "cassie_sim_set_geom_name_size",
    "cassie_sim_set_geom_name_friction",
    "cassie_reload_xml",
    "cassie_vis_apply_force",
    "cassie_vis_add_marker",
    "cassie_vis_remove_marker",
    "cassie_vis_clear_markers",
    "cassie_vis_update_marker_pos",
    "cassie_vis_update_marker_size",
    "cassie_vis_update_marker_rgba",
    "cassie_vis_update_marker_orient",
    "cassie_sim_foot_quat",
    "cassie_sim_body_vel",
    "cassie_sim_set_body_name_mass",
    "cassie_sim_get_hfield_nrow",
    "cassie_sim_get_hfield_ncol",
    ...
    "cassie_sim_get_hfield_size",
    "cassie_sim_set_hfield_size",
    "cassie_sim_hfielddata",
    "cassie_sim_set_hfielddata",
    "cassie_sim_foot_quat",
    "cassie_sim_body_vel",
    "cassie_sim_set_body_name_mass",
    "cassie_vis_set_cam",
    "cassie_sim_joint_filter",
    "cassie_sim_drive_filter",
    "cassie_sim_set_joint_filter",
    "cassie_sim_set_drive_filter",
    "cassie_sim_get_joint_filter",
    "cassie_sim_get_drive_filter",
    "cassie_sim_torque_delay",
    "cassie_sim_set_torque_delay",
    "drive_filter_t",
    "joint_filter_t",
    "cassie_sim_params",
    ...
    "cassie_sim_nq",
    "cassie_sim_ngeom",
    "cassie_vis_record_frame",
    "cassie_vis_init_recording",
    "cassie_vis_close_recording",
    "cassie_vis_window_resize",
    "cassie_vis_attach_cam",
    "cassie_vis_draw_depth",
    "cassie_vis_get_depth_size",
    "cassie_vis_init_depth",
    "cassie_vis_attach_cam",
    "cassie_vis_remakeSceneCon",
    "cassie_vis_full_reset",
    ...
    "cassie_sim_site_xpos",
    "cassie_vis_set_cam_pos",
    "cassie_sim_timestep",
    "cassie_sim_set_timestep",
    "cassie_sim_just_set_const",
    ...
    "cassie_sim_body_contact_force",
    "cassie_sim_body_acceleration",
    "cassie_sim_mj_name2id",
    "cassie_sim_nu",
    "cassie_sim_njnt",
    "cassie_sim_ctrl",
    "cassie_sim_jnt_qposadr",
    "cassie_sim_jnt_dofadr",
    "cassie_sim_site_xquat",
    "cassie_sim_relative_pose",
    "cassie_sim_geom_collision",
    "cassie_vis_init_rgb",
    "cassie_vis_get_rgb",
]
